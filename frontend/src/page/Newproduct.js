...
const Newproduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (name && image && category && price) {
      ...
      //after submit data form fields will be empty
      setData(() => {
        return {
          name: "",
          category: "",
  ...
  return (
    <div className='p-4'>
      ...
      <form className='m-auto w-full max-w-md shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <select className='bg-slate-200 p-1 my-1a' id='category' name='category' onChange={handleOnChange} value={data.category} >
